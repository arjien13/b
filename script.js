...
document.querySelectorAll('.bio-photo, .profession, #resume-section, .Portfolio-Section, .folder-container').forEach(element => element.style.display = 'none');
...
// BIO SECTION
function showBio() {
  setDisplay('.intro, .footer, .icons, #resume-section, .Portfolio-Section, .folder-container', 'none');
  setDisplay('.bio-section, .bio-paragraph, .bio-photo, .profession', 'block');
}

// RESUME SECTION
function showResume() {
  setDisplay('.intro, .footer, .icons, .bio-photo, .profession, .bio-paragraph, .bio-section, .Portfolio-Section', 'none');
...
function showPortfolio() {
  ...
  setDisplay('.Portfolio-Section, .folder-container', 'block');
}