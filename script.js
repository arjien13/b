...
document.querySelectorAll('.bio-photo, .profession, #resume-section, .Portfolio-Section').forEach(element => element.style.display = 'none');
...
// BIO SECTION
function showBio() {
  setDisplay('.intro, .footer, .icons, #resume-section, .Portfolio-Section', 'none');
...
function showPortfolio() {
  ...
  setDisplay('.Portfolio-Section', 'block');
}